  ...
  return (
    <header className="pt-20 pb-12 grid grid-flow-row">
      ...
      <ul className='flex justify-between py-10 mx-8 text-3xl'>
        <li>
          <Link href='https://twitter.com/SanCruz_Dev/'>
        ...
        <li> 
          <Link href='https://www.linkedin.com/in/sanmir-cruz/'>
        ...
        <li> 
          <Link href='https://github.com/Sancruz-dev/'>
        ...
        <li>
          <Link href='https://www.instagram.com/sancruz_dev/'>
